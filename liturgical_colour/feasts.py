...
def lookup_feast(datecode):
    ...
    feasts = {
        ...
        0 : { 'name': 'Easter', 'url': '', 'prec':9 },
        39: { 'name': 'Ascension', 'url': '', 'prec':9 },
        49: { 'name': 'Pentecost', 'colour': 'red', 'url': '', 'prec':9 },
        56: { 'name': 'Trinity', 'url': '', 'prec':9 },

        # And others:
        -46: { 'name': 'Ash Wednesday', 'colour':'purple', 'url': '', 'prec':7 },
        # is the colour of Shrove Tuesday right?
        -47: { 'name': 'Shrove Tuesday', 'colour':'white', 'url': '', 'prec':7 },
        # Actually, Easter Eve doesn't have a colour
        -1: { 'name': 'Easter Eve', 'colour':'purple', 'url': '', 'prec':7 },
        -2: { 'name': 'Good Friday', 'colour':'purple', 'url': '', 'prec':7 },

        50: { 'name': 'Book of Common Prayer', 'url': '', 'prec':3 },

        # Dates relative to Christmas are encoded as 10000 + 100*m + d for simplicity.
        10101: { 'name': 'The Naming and Circumcision of Jesus', 'url': '', 'prec':7, 'url':'https://en.wikipedia.org/wiki/Circumcision_of_Christ'},
        10102: { 'name': 'Basil the Great and Gregory of Nazianzus', 'url': 'https://en.wikipedia.org/wiki/Basil_of_Caesarea', 'prec':4},
        10106: { 'name': 'Epiphany', 'url': 'https://en.wikipedia.org/wiki/Epiphany_(Christian)', 'prec':9},
        ...
        10202: { 'name': 'Candlemas', 'url': 'https://en.wikipedia.org/wiki/Presentation_of_Jesus_at_the_Temple', 'prec':9},
        ...
        10214: { 'name': 'Valentine', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Saint_Valentine', 'prec':4},
        ...
        10325: { 'name': 'The Annunciation of our Lord', 'url': 'https://en.wikipedia.org/wiki/Annunciation', 'prec':9},
        ...
        10504: { 'name': 'English Saints and Martyrs of the Reformation Era', 'url': '', 'prec':4},
        ...
        10531: { 'name': 'The Visit of the Blessed Virgin Mary to Elizabeth', 'url': '', 'prec':7},
        ...
        11018: { 'name': 'Luke the Evangelist', 'url': 'https://en.wikipedia.org/wiki/Luke_the_Evangelist', 'prec':7},
        ...
        11028: { 'name': 'Simon and Jude, Apostles', 'url': 'https://en.wikipedia.org/wiki/Simon_the_Zealot', 'prec':7},
        ...
        11101: { 'name': 'All Saints', 'url': 'https://en.wikipedia.org/wiki/All_Saints%27_Day', 'prec':9},
        ...
        11108: { 'name': 'The Saints and Martyrs of England', 'url': '', 'prec':4},
        ...
        11225: { 'name': 'Christmas Day', 'url': 'https://en.wikipedia.org/wiki/Christmas_Day', 'prec':9},
